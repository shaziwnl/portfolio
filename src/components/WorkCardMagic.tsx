...
function WorkCardMagic({icon, title, company, description}: {
  ...
  const highlightWords = ["Developed", "Revamped", "Engineered", "Saved", "Incoming", "Enhanced", "Accelerated", "Currently", "Designed"];
  ...
  return (
    ...
    <span className="inline-flex h-full w-full justify-center rounded-lg bg-slate-950 px-5 text-sm text-white backdrop-blur-3xl">
      ...
      <div className='flex flex-col items-center pt-4 text-center'>
        ...
        {company === "Stripe" && <img src={icon} alt='logo of company' className='h-12 mb-5'></img>}
